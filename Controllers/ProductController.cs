...
namespace OHaraj.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        /// <summary>
        /// Get Product's 5 newest verified comments
        /// </summary>
        /// <returns></returns>
        [HttpGet("Get-Product-5Verified-Comments")]
        [Produces(typeof(Response<IEnumerable<CommentDTO>>))]
        public async Task<IActionResult> GetProduct5VerifiedComments(int productId)
        {
            return new Response<IEnumerable<CommentDTO>>(await _productService.GetProductVerifiedComments(productId, 5)).ToJsonResult();
        }
        ...
        {
            return new Response<IEnumerable<CommentDTO>>(await _productService.GetProductVerifiedComments(productId, 10)).ToJsonResult();
        }

        /// <summary>
        /// Get Product's verified comments
        /// </summary>
        /// <returns></returns>
        [HttpGet("Get-Product-Verified-Comments")]
        [Produces(typeof(Response<IEnumerable<CommentDTO>>))]
        public async Task<IActionResult> GetProductVerifiedComments(int productId)
        {
            return new Response<IEnumerable<CommentDTO>>(await _productService.GetProductVerifiedComments(productId, null)).ToJsonResult();
        }
